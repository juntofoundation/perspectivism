...
class CommentShortFormPutAdapter implements PublicSharing {
    #agent: Agent
    #idToken: String
    ...
    async createPublic(shortForm: object): Promise<Address> {
        ...
        //@ts-ignore
        return axios.post(this.#url + "expressions/", + this.#represents.data.address + "/comments", expressionPostData)
...
export default class CommentShortFormAdapter implements ExpressionAdapter {
    #agent: Agent
    #idToken: String
    #url: String = "http://3.22.168.239/v0.2.3-alpha/"
    ...
    constructor(context: LanguageContext) {
        ...
        //@ts-ignore
        this.#idToken = context.customSettings.cognitoSession ? context.customSettings.cognitoSession.idToken : undefined;
        this.putAdapter = new CommentShortFormPutAdapter(context)
